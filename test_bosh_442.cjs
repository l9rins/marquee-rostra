...
function dumpTendencies(base, name) {
    ...
    for (let t = 0; t < 58; t++) { 
        ...
        if (t===0 || t===1 || t===4 || t===25 || t===30 || t===33 || t===36 || t===45) {
...
// Bosh Array Offset
dumpTendencies(1315323, "Chris Bosh (1014)");

// Just checking a random player next to him (1316346 -> CFID 1778)
dumpTendencies(1316346, "Player 1778");
